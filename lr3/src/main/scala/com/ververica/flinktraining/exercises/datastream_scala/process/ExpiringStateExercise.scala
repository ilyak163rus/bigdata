...
object ExpiringStateExercise {
  ...
  private val stateTimeout = 60 * 1000L
  ...
  override def processElement1(
    ...
    if (fare != null) {
      ...
      context.timerService().registerEventTimeTimer(ride.getEventTime + stateTimeout)
    }
  }
  ...
  override def processElement2(
    ...
    if (ride != null) {
      ...
      context.timerService().registerEventTimeTimer(fare.getEventTime + stateTimeout)
    }
  }
